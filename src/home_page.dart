...
class _HomePageState extends State<HomePage> {
  ...
  void _processFile() async {
    ...
    if (selectedFile == null || selectedSize == null) {
      showErrorBanner(langProvider.localizedStrings["plssel_file"] ?? "Please select a file, format, and size.");
      return;
    }
    ...
    try {
      ...
      if (selectedFormat == "raw") {
        outputPath = await FileProcessor.processBinToRaw(selectedFile!, selectedSize!);
      } else {
        outputPath = await FileProcessor.processBinToPng(selectedFile!, selectedSize!);
      }

      showResultDialog(context, outputPath);
    } catch (e) {
      showErrorBanner("${langProvider.localizedStrings["error"]}: $e");
    }
  }
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 20),
                    Tooltip(
                      message: langProvider.localizedStrings["select_language"] ?? "Select language",
                      child: AnimatedIconButton(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    _buildSocialIcon("lib/src_assets/git.png", "https://github.com/stakanyash/displacebin_gui_converter", size: 25),
                    SizedBox(width: 20),
                    _buildSocialIcon("lib/src_assets/dis.png", "https://discord.com/invite/Cd5GanuYud", size: 25),
                    SizedBox(width: 20),
                    _buildSocialIcon("lib/src_assets/tg.png", "https://t.me/stakanyasher", size: 25),
                    SizedBox(width: 20),
                    _buildSocialIcon("lib/src_assets/yt.png", "https://www.youtube.com/@stakanyash", size: 25),
                  ],
                ),
                SizedBox(height: 20),
                Align(
